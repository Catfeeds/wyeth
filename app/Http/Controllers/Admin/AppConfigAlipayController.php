...
class AppConfigAlipayController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('admin.module.config_alipay', ['fields' => $this->config, 'page'=>'alipay'])
    ...
    public function store(Request $request)
    {
        ...
        return view('admin.error', ['msg' => '已更新', 'url' => "/admin/app_config/alipay"]);
    }
    ...
    public function subtableEdit(Request $request, $field, $id)
    {
        ...
        $user_info = Session::get('admin_info');
        return view('admin.module.subtable_alipay_edit', ['fields' => $fields, 'id' => $id, 'field' => $field])
            ->nest('header', 'admin.common.header', ['user_info' => $user_info])
            ->nest('sidebar', 'admin.common.sidebar', ['menu' => $request->admin->menu])
            ->nest('footer', 'admin.common.footer', []);
    }
    ...
    public function subtableDestroy(Request $request, $field, $id)
    {
        ...
        if ($config) {
            ...
            return view('admin.error', ['msg' => '已删除', 'url' => "/admin/app_config/alipay"]);
        }
