...
<head>
    ...
    <link rel="stylesheet" type="text/css"
          href="{{ config('course.static_url') }}/mobile/review/css/reset.css?v={{$resource_version}}">
    <script>
                ...
                <li class="href" location="{{ $item['url'] }}">
                    ...
                    <div class="right_test">
                        ...
                        <div>
                            ...
                            <span class="teacher-info">{{mb_substr($item['teacher_hospital'], 0, 18, 'utf-8')}}</span><br>
                        </div>
                        <div>
