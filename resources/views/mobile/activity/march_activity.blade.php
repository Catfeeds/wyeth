...
@if(!$share_str)
    <div class="main-body" id="#content-container">
        ...
        @foreach($configs->courses as $index => $course)
            <div class="container-course" style="margin-top: @if($index == 0) 110px @else 85px @endif">
                <div class="container-voice" style="border: #FAC13B 3px solid;">
                    ...
                    <div style="display: flex;flex-direction: column;height: 170px;padding: 20px 0 24px 0;">
        ...
        {{--@if($invite_num)--}}
            @if($user->crm_status)
                <img src="{{$su}}/mobile/images/activity/2/btn_get_more_v2.png" style="width: 312px; height: 94px; margin-top: 143px" onclick="window.location.href = '/mobile/index?defaultPath=/all&forcejump=1'">
            @else
                <img src="{{$su}}/mobile/images/activity/2/btn_get_more_v2.png" style="width: 312px; height: 94px; margin-top: 143px" onclick="goRegister()">
            @endif
        {{--@else--}}
...
<div class="pop-window" id="ruleWindow">
    ...
    <div class="pop-window-rule">
        <div style="margin-top: 103px; height: 760px; overflow: scroll">
            <span class="text-rule-desc">1.魔栗孕育指南第1节课免费试听，第2/3/4节课需要邀请成功邀请1名好友注册惠氏妈妈俱乐部，即可解锁。</span>
            ...
            <span class="text-rule-desc">4.活动开奖时间为2018年3月22日。</span>
...
//                }
    ...
    var shareDesc = '怀孕生娃后，只能当“胖”妈？学会这4招，做辣妈很简单~';
