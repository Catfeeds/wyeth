...
<html>
    <head>
        ...
        <style type="text/css">
            ...
            .page a{width:79.066667%; height:8.699254%; top:80%; left:10%; position:absolute; background: url(./img/no_review_btn.png) no-repeat; background-size:100% auto; -webkit-tap-highlight-color:rgba(0,0,0,0);}
    ...
    <body>
        <div class="page">
            <img src="<?=config('course.static_url');?>/mobile/img/no_review_bg.png" alt="">
            <p class="p1">亲爱的妈妈:</p>
            <p class="p2">课程回顾生成中，请稍后再来哦~</p>
            <a href="/mobile/index"></a>
        </div>
    </body>
</html>