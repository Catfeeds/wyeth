...
<html>
    <head>
        ...
        <style type="text/css">
            ...
            .page a{width:79.066667%; height:8.699254%; top:80%; left:10%; position:absolute; background: url({{config('course.static_url')}}/mobile/img/no_review_btn_2.png) no-repeat; background-size:100% auto; -webkit-tap-highlight-color:rgba(0,0,0,0);}
