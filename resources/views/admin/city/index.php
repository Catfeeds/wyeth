                        ...
                        <div class="panel-body">
                            <section id="unseen">
                                <div class="row-fluid" style="margin-bottom: 10px;">
                                    <div class="clearfix">
                                        <div class="btn-group">
                                            <a href="/admin/city/add/0">
                                            <button id="editable-sample_new" class="btn green">
                                                添加新城市 <i class="fa fa-plus"></i>
                                            </button>
                                            </a>
                                        </div>
                                    </div>
                                        ...
                                        foreach ($list as $k => $item) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="">
                                                    ...
                                                    <a href="/admin/city/delete/<?php echo $item->id; ?>" onclick="return confirm('您确定要删除该内容吗？');" class="btn btn-danger btn-xs"><i class="fa fa-trash-o "></i>删除</a>
                                                </td>
                                            </tr>
                                        <?php }
                                    }
