    ...
    <div class="panel-body">
        <div class=" form">
            <form class="cmxform form-horizontal tasi-form" id="courseForm" method="post" action="" enctype="multipart/form-data">
                ...
                <div class="form-group ">
                    <label for="teacher_hospital" class="control-label col-lg-2">城市</label>
                    <div class="col-lg-6">
                        <input class=" form-control" id="word" name="city" minlength="2" type="text" value="<?php echo isset($info->city)?$info->city:''; ?>">
                    </div>
                </div>
                <div class="form-group">
