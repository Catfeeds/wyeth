            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="/admin/anchor/edit/<?php echo $id; ?>">主持人编辑</a><span class="divider-last">&nbsp;</span></li>
                    </ul>
                </div>
            </div>
            <!-- END PAGE HEADER-->
                ...
                <div class="span12">
                    ...
                    <div class="widget">
                        <div class="widget-title">
                            <h4><i class="icon-reorder"></i>主持人编辑</h4>
                        </div>
                        <div class="widget-body form">
                            ...
                            <form action="#" method="post" class="form-horizontal add_form" enctype="multipart/form-data">
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" class="span3 " class="name" value="<?php echo $info->name; ?>" name="name" datatype="*" nullmsg="aaa" errormsg="请填写主持人名称" />
