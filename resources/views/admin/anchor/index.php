...
<div class="container">
    <a href="/admin/anchorLogout" style="position: absolute; right: 10%; top: 8px;"><i class="fa"></i> 退出登录</a>
                ...
                <div class="tab-content tasi-tab">
                    <div class="tab-pane active" id="course_enroll">
                        <?php foreach($course_enroll as $v) { ?>
                            <article class="media">
                                <a class="pull-left thumb p-thumb" href="/admin/anchor/live/<?=$v->id?>">
                                    <img src="<?=$v->img?>">
                                </a>
                                <div class="media-body">
                                    <a class="cmt-head" href="/admin/anchor/live/<?=$v->id?>"><?=$v->title?></a>
                        ...
                        <?php foreach($course_end as $v) { ?>
                            <article class="media" style="position: relative">
                                ...
                                <div style="position: absolute; right: 0; top: 16px;">
                                    <a class="cmt-head" href="/admin/anchor/msg/<?=$v->id?>">消息管理</a>
                                </div>
                            </article>
                        <?php } ?>
                    </div>
