                            ...
                            <div class=" form">
                                <form class="cmxform form-horizontal tasi-form" id="courseForm" method="post" action="" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-6">
                                            <textarea class="form-control " id="content" name="content"><?php echo $info->content; ?></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3 col-xs-11">
                                            <input class="form-control form-control-inline input-medium date-picker" size="16" type="text" name="end_day" value="<?php echo $info->end_day; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3 col-xs-11">
                                            <div class="input-group bootstrap-timepicker">
                                                <input type="text" class="form-control timepicker-24-start" name="start_time" value="<?php echo $info->start_time; ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3 col-xs-11">
                                            <div class="input-group bootstrap-timepicker">
                                                <input type="text" class="form-control timepicker-24-end" name="end_time" value="<?php echo $info->end_time; ?>">
                                                <span class="input-group-btn">
                                                <button class="btn btn-default" type="button"><i class="fa fa-clock-o"></i></button>
                                                </span>
                                            </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="shihe_1" style="float: left;">
                                                <select name="stage[1][1]" class="form-control m-bot15" onchange="shihe(this);" style="float: left; width: 70px;">
                                                    ...
                                                    <option value="孕中" <?php echo $info->stage[1][0] == '孕中' ? 'selected' : ''; ?>>孕中</option>
                                                    <option value="宝宝" <?php echo $info->stage[1][0] == '宝宝' ? 'selected' : ''; ?>>宝宝</option>
                                                </select>
                                                <select class="yunzhong form-control m-bot15" name="stage[1][2]" style="float: left; width: 100px; <?php if ($info->stage[1][0] != '孕中') {echo 'display: none;';}
?>">
                                                    <option value="0个月">0个月</option>
                                                    <option value="1个月" <?php echo $info->stage[1][1] == '1个月' ? 'selected' : ''; ?>>1个月</option>
                                                    <option value="2个月" <?php echo $info->stage[1][1] == '2个月' ? 'selected' : ''; ?>>2个月</option>
                                                    <option value="3个月" <?php echo $info->stage[1][1] == '3个月' ? 'selected' : ''; ?>>3个月</option>
                                                    <option value="4个月" <?php echo $info->stage[1][1] == '4个月' ? 'selected' : ''; ?>>4个月</option>
                                                    <option value="5个月" <?php echo $info->stage[1][1] == '5个月' ? 'selected' : ''; ?>>5个月</option>
                                                    <option value="6个月" <?php echo $info->stage[1][1] == '6个月' ? 'selected' : ''; ?>>6个月</option>
                                                    <option value="7个月" <?php echo $info->stage[1][1] == '7个月' ? 'selected' : ''; ?>>7个月</option>
                                                    <option value="8个月" <?php echo $info->stage[1][1] == '8个月' ? 'selected' : ''; ?>>8个月</option>
                                                    <option value="9个月" <?php echo $info->stage[1][1] == '9个月' ? 'selected' : ''; ?>>9个月</option>
                                                    <option value="10个月" <?php echo $info->stage[1][1] == '10个月' ? 'selected' : ''; ?>>10个月</option>
                                                </select>
                                                <select class="baobao form-control m-bot15" name="stage[1][3]" style="float: left; width: 70px; <?php if ($info->stage[1][0] != '宝宝') {echo 'display: none;';}
?>">
                                                    <option value="0岁">0岁</option>
                                                    <option value="1岁" <?php echo $info->stage[1][1] == '1岁' ? 'selected' : ''; ?>>1岁</option>
                                                    <option value="2岁" <?php echo $info->stage[1][1] == '2岁' ? 'selected' : ''; ?>>2岁</option>
                                                    <option value="3岁" <?php echo $info->stage[1][1] == '3岁' ? 'selected' : ''; ?>>3岁</option>
                                                    <option value="4岁" <?php echo $info->stage[1][1] == '4岁' ? 'selected' : ''; ?>>4岁</option>
                                                    <option value="5岁" <?php echo $info->stage[1][1] == '5岁' ? 'selected' : ''; ?>>5岁</option>
                                                    <option value="6岁" <?php echo $info->stage[1][1] == '6岁' ? 'selected' : ''; ?>>6岁</option>
                                                </select>
                                            </div>
                                            ...
                                            <div class="shihe_2" style="float: left">
                                                <select name="stage[2][1]" class="form-control m-bot15" onchange="shihe(this);" style="float: left; width:70px;">
                                                    <option value="备孕">备孕</option>
                                                    <option value="孕中" <?php echo $info->stage[2][0] == '孕中' ? 'selected' : ''; ?>>孕中</option>
                                                    <option value="宝宝" <?php echo $info->stage[2][0] == '宝宝' ? 'selected' : ''; ?>>宝宝</option>
                                                </select>
                                                <select class="yunzhong form-control m-bot15" name="stage[2][2]" style="float: left; width: 100px; <?php if ($info->stage[2][0] != '孕中') {echo 'display: none;';}
?>">
                                                    <option value="0个月">0个月</option>
                                                    <option value="1个月" <?php echo $info->stage[2][1] == '1个月' ? 'selected' : ''; ?>>1个月</option>
                                                    <option value="2个月" <?php echo $info->stage[2][1] == '2个月' ? 'selected' : ''; ?>>2个月</option>
                                                    <option value="3个月" <?php echo $info->stage[2][1] == '3个月' ? 'selected' : ''; ?>>3个月</option>
                                                    <option value="4个月" <?php echo $info->stage[2][1] == '4个月' ? 'selected' : ''; ?>>4个月</option>
                                                    <option value="5个月" <?php echo $info->stage[2][1] == '5个月' ? 'selected' : ''; ?>>5个月</option>
                                                    <option value="6个月" <?php echo $info->stage[2][1] == '6个月' ? 'selected' : ''; ?>>6个月</option>
                                                    <option value="7个月" <?php echo $info->stage[2][1] == '7个月' ? 'selected' : ''; ?>>7个月</option>
                                                    <option value="8个月" <?php echo $info->stage[2][1] == '8个月' ? 'selected' : ''; ?>>8个月</option>
                                                    <option value="9个月" <?php echo $info->stage[2][1] == '9个月' ? 'selected' : ''; ?>>9个月</option>
                                                    <option value="10个月" <?php echo $info->stage[2][1] == '10个月' ? 'selected' : ''; ?>>10个月</option>
                                                </select>
                                                <select class="baobao form-control m-bot15" name="stage[2][3]" style="float: left; width: 100px; <?php if ($info->stage[2][0] != '宝宝') {echo 'display: none;';}
?>">
                                                    <option value="0岁">0岁</option>
                                                    <option value="1岁" <?php echo $info->stage[2][1] == '1岁' ? 'selected' : ''; ?>>1岁</option>
                                                    <option value="2岁" <?php echo $info->stage[2][1] == '2岁' ? 'selected' : ''; ?>>2岁</option>
                                                    <option value="3岁" <?php echo $info->stage[2][1] == '3岁' ? 'selected' : ''; ?>>3岁</option>
                                                    <option value="4岁" <?php echo $info->stage[2][1] == '4岁' ? 'selected' : ''; ?>>4岁</option>
                                                    <option value="5岁" <?php echo $info->stage[2][1] == '5岁' ? 'selected' : ''; ?>>5岁</option>
                                                    <option value="6岁" <?php echo $info->stage[2][1] == '6岁' ? 'selected' : ''; ?>>6岁</option>
                                                </select>
                                            </div>
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-6">
                                            <input class=" form-control" id="teacher_name" name="teacher_name" minlength="2" type="text" value="<?php echo $info->teacher_name; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label for="teacher_hospital" class="control-label col-lg-2">讲师来源</label>
                                        <div class="col-lg-6">
                                            <input class=" form-control" id="teacher_source" name="teacher_source" minlength="2" type="text" value="<?php echo $info->teacher_source; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label for="teacher_position" class="control-label col-lg-2">讲师职称</label>
                                        <div class="col-lg-6">
                                            <input class=" form-control" id="teacher_position" name="teacher_position" minlength="2" type="text" value="<?php echo $info->teacher_position; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label for="teacher_desc" class="control-label col-lg-2">讲师简介</label>
                                        <div class="col-lg-6">
                                            <textarea class="form-control " id="teacher_desc" name="teacher_desc"><?php echo $info->teacher_desc; ?></textarea>
                                        </div>
                                    </div>
                                    <?php if ($info->status == 2) { ?>
                                    <div class="form-group">
                                        <label for="status" class="control-label col-lg-2">重新申请</label>
                                        <div class="col-lg-6">
                                            <input type="checkbox" id="status" data-toggle="switch" value="0" name="status" />
                                        </div>
                                    </div>
                                    <?php } ?>
                                    <div class="form-group">
