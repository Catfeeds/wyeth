                                        ...
                                        @foreach ($list as $k => $item)
                                            <tr class="gradeA">
                                                ...
                                                <td>
                                                    ...
                                                    <a href="/admin/course_export/export?type=review_record&id=<?php echo $item->id; ?>" class="btn btn-primary btn-xs">课程回顾统计</a>
                                                    <a href="/admin/course_export/export?type=recommend_course&id=<?php echo $item->id; ?>" class="btn btn-primary btn-xs">课程推荐记录</a>
                                                </td>
                                            </tr>
                                        @endforeach
                                    @endif
