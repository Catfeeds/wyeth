                                            ...
                                            <div class="tab-content">
                                                <div id="home" class="tab-pane active">
                                                    <div class="form-group ">
                                                        ...
                                                        <div class="col-lg-4">
                                                            <select name="cid" class="form-control m-bot15" id="cid">
                                                                <?php foreach($course_list as $k=>$v){ ?>
                                                                <option value="<?=$v->id;?>"
                                                                    <?php if ($v->id == $cid) { ?> selected="selected" <?php } ?>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-lg-4">
                                                            <select name="review_type" class="form-control m-bot15">
                                                                <option value="1" selected='selected'>音频</option>
                                                    ...
                                                    <div class="form-group">
                                                        <label class="control-label col-lg-2">添加回顾视频</label>
                                                        <div class="controls col-md-9">
                                                            <div id="container">
                                                                <a id="pickfiles" href="#">
                                                                    <span class="btn btn-white btn-file">
                                                        ...
                                                        <section class="panel  col-lg-10">
                                                            ...
                                                            <div class="panel-body">
                                                                <script id="guide" name="guide" type="text/plain"
                                                                        style="width:900px;height:300px;"></script>
                                                            </div>
                                                        </section>
                                                    </div>
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-lg-6" style="z-index: 9999">
                                                            <input type="checkbox" data-toggle="switch" value="1" name="status"/>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                ...
                                                <div id="questions_and_answers" class="tab-pane">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-lg-offset-2 col-lg-10">
                                                            <button class="btn btn-danger" type="submit">保存</button>
                                                            <button class="btn btn-default" type="reset">重置</button>
                                                            <button class="btn btn-default" type="button" id="add">增加</button>
                                                            <button class="btn btn-default" type="button" id="delete">删除最后一组问答</button>
                                                        </div>
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="txt_audio" style="width: 35%;display:flex;flex-direction: column">
                                                            <div class="form-group">
                                                                ...
                                                                <div style="margin-top: 10%;margin-left: 5%">
                                                                    <textarea id="text_area" name="content" class="textarea thumbnail" style="width:80%; height: 400px;resize:none;"></textarea>
                                                                </div>
                                                            </div>
                                                            <!--
                                                            <div class="form-group">
                                                                <label class="control-label col-lg-6">课程音频数据</label>
                                                            </div>
...
<script>
    ...
    $.ajax({
        type: 'POST',
        url: '/admin/course_review/questions',
        dataType: 'json',
        data: {
            cid: cid
        },
        success: function(data){
            html = "<select name='question' class='form-control m-bot15'>"+
                    "<option uid=''></option>";
            $.each(data, function(i, n) {
                var content = htmlEncode(n.content);
                html += "<option uid='" + n.author_id + "'>" + content + "</option>";
            });
            html += "</select>";
        }
    });
    select.onchange = function(){
        ...
        $.ajax({
            ...
            success: function(data){
                ...
                $.each(data, function(i, n) {
                    var content = htmlEncode(n.content);
                    html += "<option uid='" + n.author_type + "'>" + content + "</option>";
                });
                html += "</select>";
            }
        });
    ...
    $(function(){
        ...
        $('body').on('click','#add-gist',function(){
            ...
            var html = (
                ...
                '</div>'+
                '<div class="col-lg-2">'+
                '<input placeholder="开始时间(秒)" class="form-control" name="section['+name_num+'][second]" type="hidden" value="">'+
                '</div>'+
                '<div  id='+gist_num+'>'+
                '<div  class="form-group">'+
                '</div>'+
        ...
        $('body').on('click','#add-section',function(){
            ...
            var sec_html = (
                ...
                '<div style="display:flex;align-items:center">'+
                '<input placeholder="请填写本节名称(20字以内)" style="width:46%"  class="form-control" name="section['+real_num+'][section]['+sec_name_num+'][point]" type="text" value="" onkeyup="checkSize1(this)">'+
