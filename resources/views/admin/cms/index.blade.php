                ...
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <button class="btn btn-shadow btn-info" onclick="goToCMS()">进入CMS管理</button>
                            <p style="margin-top: 20px">账号：15651629113</p>
                            <p>密码：123456</p>
                            <p>步骤1：</p>
                            <img src="/admin_style/img/cms-step-1.jpg">
                            <p>步骤2：</p>
                            <img src="/admin_style/img/cms-step-2.jpg">
                        </div>
                    </section>
                </div>
            </div>
...
<script>
    function goToCMS() {
        window.open('http://oneitfarm.com/cms/main.php?action=article.html&appkey={{config('oneitfarm.appkey')}}&channel=0')
    }
</script>
