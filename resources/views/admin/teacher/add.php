            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="/admin/teacher/add">添加教师</a><span class="divider-last">&nbsp;</span></li>
                    </ul>
                </div>
            </div>
            <!-- END PAGE HEADER-->
                ...
                <div class="span12">
                    ...
                    <div class="widget">
                        <div class="widget-title">
                            <h4><i class="icon-reorder"></i>添加教师</h4>
                        </div>
                        <div class="widget-body form">
                            ...
                            <form action="#" method="post" class="form-horizontal add_form" enctype="multipart/form-data">
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" class="span3 " class="name" name="name" datatype="*" nullmsg="aaa" errormsg="请填写教师名称" />
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" class="span3 " class="name" name="hospital" datatype="*" errormsg="请填写任职医院" />
                                        <span class="help-inline"></span>
                                    </div>
                                </div>
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" class="span3 " class="name" name="position" datatype="*" errormsg="请填写教师职位" />
                                        <span class="help-inline"></span>
                                    </div>
                                </div>
                                <div class="control-group">
