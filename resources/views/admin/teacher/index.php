...
<div class="container">
    <a href="/admin/teacherLogout" style="position: absolute; right: 10%; top: 8px;"><i class="fa"></i> 退出登录</a>
    <img src="/admin_style/img/anchor_logo.png" style="margin: 40px auto 0; display: block; width: 400px;"/>
    <img src="<?=$course_info->teacher_avatar?>" style="margin: 10px auto 5px; display: block; width: 80px;"/>
    <p style="text-align: center;"><?=$course_info->teacher_name?></p>
            ...
            <div class="panel-body">
                <div class="tab-content tasi-tab">
                    <div class="tab-pane active" id="course_enroll">
                        ...
                        <article class="media">
                            <a class="pull-left thumb p-thumb" href="/admin/teacher/live/<?=$v->id?>">
                                <img src="<?=$v->img?>">
                            </a>
                            <div class="media-body">
                                <a class="cmt-head" href="/admin/teacher/live/<?=$v->id?>"><?=$v->title?></a>
