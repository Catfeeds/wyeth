        ...
        <section class="panel">
            <div class="user-heading alt green-bg" style="padding: 8px; position: relative;">
                ...
                <div style="position: absolute; top:0; right:0; width:50%; padding: 8px;">
                    <p style="font-size: 16px;">
                        <a href="/admin/teacher/index" style="float: right; font-size: 12px;">返回课程列表</a>
                    </p>
...
var user_type = 3;
var author_id = {{$teacher_uid}};
var teacher_uid = {{$teacher_uid}};
var anchor_id = {{$anchor_uid}};
