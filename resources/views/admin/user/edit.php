                            ...
                            <div class=" form">
                                <form class="cmxform form-horizontal tasi-form" id="courseForm" method="post" action="" enctype="multipart/form-data">
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-6">
                                            <input class=" form-control" id="nickname" name="nickname" minlength="2" type="text" value="<?php echo $info->nickname; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group ">
                                        <label for="desc" class="control-label col-lg-2">openid</label>
                                        <div class="col-lg-6">
                                            <?php echo $info->openid; ?>
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label for="notice" class="control-label col-lg-2">性别</label>
                                        <div class="col-lg-6">
                                            <?php if($info->sex == 1){ echo '男';}elseif($info->sex == 2){ echo '女';}else{ echo '未知';} ?>
                                        </div>
                                    </div>
                                    <div class="form-group">
