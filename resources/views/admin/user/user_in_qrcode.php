                        ...
                        <div class="panel-body">
                            <section id="unseen">
                                <div class="row-fluid">
                                    <div class="clearfix">
                                        <div class="btn-group">
                                            <a href="/admin/user/userInQrcodeAdd">
                                    ...
                                    <tbody>
                                        <?php if (!empty($list)) {foreach ($list as $k => $item) { ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo $item->stageStr; ?></td>
                                                    <td><img src="<?php echo $item->imgurl; ?>" width="100"></td>
                                                    <td class="">
                                                        <a href="/admin/user/userInQrcodeEdit/<?php echo $item->id; ?>" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i>编辑</a>
                                                        <a href="/admin/user/userInQrcodeDelete/<?php echo $item->id; ?>" onclick="return confirm('您确定要删除该内容吗？');" class="btn btn-danger btn-xs"><i class="fa fa-trash-o "></i>删除</a>
                                                    </td>
                                                </tr>
                                        <?php }} ?>
                                    </tbody>
