        ...
        <div class=" form">
            <form class="cmxform form-horizontal tasi-form" id="courseForm" method="post" action="" enctype="multipart/form-data">
                    ...
                    <div class="col-md-9">
                        <div class="fileupload fileupload-new" data-provides="fileupload">
                            <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;">
                                <img src="<?php echo !empty($info->imgurl) ? $info->imgurl : '/admin_style/img/no_image.png'; ?>" alt="">
                            </div>
                ...
                <div class="form-group ">
                    ...
                    <div class="col-lg-6">
                        <input class=" form-control" id="name" name="name" minlength="2" type="text" value="<?php echo isset($info->name) ? $info->name : ''; ?>">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-lg-6">
                        <div style="float: left;">
                            <select name="stage" class="form-control m-bot15">
                                <option value="1" <?php echo isset($info->baby_status)&&$info->baby_status==1?'selected':''; ?>>孕期</option>
                                <option value="2" <?php echo isset($info->baby_status)&&$info->baby_status==2?'selected':''; ?>>宝宝已出生</option>
                            </select>
                        </div>
